...
var setup = function () {
  ...
  this.VKI_layout['\u05d9\u05d9\u05b4\u05d3\u05d9\u05e9'] = {
    // from https://www.yv.org/uyip/hebyidkbd.txt https://uyip.org/keyboards.html
    name: 'Yiddish',
    keys: [
      [
        [';', '~', '\u05B0'],
  ...
  VKI_attach = function (elem) {
    ...
    if (self.VKI_flashPassword && elem.getAttribute('VKI_type') == 'password') {
      ...
      elem.addEventListener(
        'focus',
        function () {
          if (typeof this.timeout !== 'number') this.storeValue = this.value
        },
        false
      )
    ...
    if (elem.getAttribute('VKI_numpadInput') == 'true') {
      ...
      elem.addEventListener(
        'beforeinput',
        function () {
          if (this.getAttribute('VKI_type') != 'password') this.storeValue = this.value
        },
        false
      )
      elem.addEventListener(
        ...
        function () {
          ...
          if (
            !this.value.match(new RegExp(this.pattern)) ||
            (this.max && parseFloat(this.value) > parseFloat(this.max)) ||
            (this.min && parseFloat(this.value) < parseFloat(this.min))
          ) {
            if (this.getAttribute('VKI_type') != 'password') this.value = this.storeValue
          }
        },
        false
      )
  ...
  if (this.VKI_deadBox) {
    ...
    checkbox.title =
      this.VKI_i18n['03'] + ': ' + (this.VKI_deadkeysOn ? this.VKI_i18n['04'] : this.VKI_i18n['05'])
    ...
    VKI_addListener(
      ...
      function () {
        this.title =
          self.VKI_i18n['03'] + ': ' + (this.checked ? self.VKI_i18n['04'] : self.VKI_i18n['05'])
        self.VKI_modify('')
        return true
      },
      false
  ...
  this.VKI_modify = function (type) {
    ...
    let tables = this.VKI_keyboard.tBodies[0]
    ...
    if (
      ...
      if (this.VKI_target.setSelectionRange && !this.VKI_target.readOnly && !this.VKI_isIE) {
        ...
        this.VKI_target.value =
          this.VKI_target.value.substr(0, rng[0]) + text + this.VKI_target.value.substr(rng[1])
  ...
  this.VKI_backspace = function () {
    ...
    if (self.VKI_target.setSelectionRange && !self.VKI_target.readOnly) {
      ...
      self.VKI_target.value =
        self.VKI_target.value.substr(0, rng[0] - 1) + self.VKI_target.value.substr(rng[1])
      ...
      if (this.VKI_langAdapt && this.VKI_target.lang) {
        ...
        for (let x = 0; !chg && x < this.VKI_langCode.index.length; x++)
          if (lang.indexOf(this.VKI_langCode.index[x]) == 0)
            chg =
              kbSelect.firstChild.nodeValue =
              this.VKI_kt =
                this.VKI_langCode[this.VKI_langCode.index[x]]
  ...
  this.VKI_position = function (force) {
    if (self.VKI_target) {
      let kPos = VKI_findPos(self.VKI_keyboard),
      ...
      if (place || force === true) {
        let iPos = VKI_findPos(self.VKI_target),
          scr = self.VKI_target
        while ((scr = scr.parentNode)) {
          ...
          if (scr.scrollHeight > scr.offsetHeight || scr.scrollWidth > scr.offsetWidth) {
            ...
            self.VKI_keyboard.style.display =
              top < 0 || left < 0 || bottom < 0 || right < 0 ? 'none' : ''
            if (self.VKI_isIE6)
              self.VKI_iframe.style.display =
                top < 0 || left < 0 || bottom < 0 || right < 0 ? 'none' : ''
          }
        }
  ...
  this.VKI_close = VKI_close = function () {
    if (this.VKI_target) {
      ...
      if (this.VKI_target.getAttribute('VKI_numpadInput') == 'true') this.VKI_target.pattern = '.*'
      try {
        this.VKI_keyboard.parentNode.removeChild(this.VKI_keyboard)
  ...
  function VKI_getStyle(obj, styleProp) {
    ...
    } else if (window.getComputedStyle) y = window.getComputedStyle(obj, null)[styleProp]
    return y
  }
