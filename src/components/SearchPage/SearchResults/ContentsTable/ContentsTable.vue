<template>
  <div class="column" v-if="searchResults?.length">
    ...
    <div
      class="is-hidden-desktop toc-mobile"
      id="mobile-navigation-toc"
      role="navigation"
      tabindex="1"
    >
      <div class="toc-mobile-left">
        <div class="columns is-mobile">
          <Transition
            ...
            @leave="leave"
          >
            <aside class="column toc-drawer menu box p-2" v-show="openMobileSearchResultsToc">
              <div>
                <p
      ...
      <div class="toc-mobile-right">
        <div class="columns is-mobile">
          <Transition
            ...
            @leave="leave"
          >
            <aside class="column toc-drawer menu box p-2" v-show="openMobileMetadataPanel">
              <SingleResult
                v-model:image-modal="imageModal"
                v-model:word-modal="wordModal"
                v-model:metadata-modal="metadataModal"
          ...
          <div class="column toc-button toc-mobile-right p-2">
            <a
              ...
              ><font-awesome-icon icon="pencil-square" size="lg" />
