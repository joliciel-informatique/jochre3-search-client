...
Children: PageNumbering, HistoryNavigator
Siblings: None

Props: search, resetSearchResults, searchResults, page, totalHits
...
<template>
  <div
    class="footerNavBar hero is-flex-direction-column is-align-items-center has-text-centered p-5 has-background-primary"
  >
