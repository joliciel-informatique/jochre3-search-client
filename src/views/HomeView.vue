...
const LargeImage = () => import('@/_components/Modals/LargeImage/LargeImage.vue')
const FixMetaData = () => import('@/_components/Modals/FixMetaData/FixMetaData.vue')
const FixWord = () => import('@/_components/Modals/FixWord/FixWord.vue')
const PreferencesSetup = () => import('@/_components/Modals/Preferences/PreferencesSetup.vue')
const Preferences = () => import('@/_components/Modals/Preferences/PreferencesModal.vue')
const Notification = () => import('@/_components/Notifications/AppNotification/AppNotification.vue')
